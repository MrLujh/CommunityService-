...
- (void)layoutAttributesForCopyRightlayout:(UICollectionViewLayoutAttributes *)layoutAttributes indexPath: (NSIndexPath *) indexPath {
    ...
    CGFloat W = 80;
    CGFloat H = W;
    CGFloat leftAndRightPading = (SCREEN_WIDTH - 3*W)/3.0;
    ...
    if (indexPath.item == 0 || indexPath.item == 6) {
        ...
        layoutAttributes.frame = CGRectMake(row * (W +leftAndRightPading) +leftAndRightPading/2.0, y +topAndBottomPading, W, H);
